    ...
    <div class="container">
      <div class="row justify-conent-center"  >
         {{-- <div class="col-md-12 col-lg-3">
          <div class="nav flex-column nav-pills settings-nav" id="v-pills-tab" aria-orientation="vertical">
              <a class="nav-link" id="settings-profile-tab" href="{{url('/profile')}}" ><i class="icon ion-md-person"></i> Profile</a>
              <a class="nav-link active" id="settings-wallet-tab" href="{{url('/wallet')}}" ><i class="icon ion-md-wallet"></i> Wallet</a>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-4">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                      <a class="nav-link d-flex justify-content-between align-items-center active" href="#coinBTC" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinETH" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinBNB" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinTRX" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinEOS" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinXMR" role="tab" aria-selected="true">
                        <div class="d-flex">
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" href="#coinKCS" role="tab" aria-selected="true">
                        <div class="d-flex">
